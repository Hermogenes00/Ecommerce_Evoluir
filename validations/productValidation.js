...
let schema = joi.object({
    ...
    vlrProduto: joi.number().precision(3).min(0.001).message('Informe um valor válido para o campo Valor Produto (obs: valor mínimo = 0,001)').required(),
    ...
    desconto: joi.number().precision(3).min(0.001).message('Informe um valor válido para o campo Valor Produto (obs: valor mínimo = 0,001)').required(),
